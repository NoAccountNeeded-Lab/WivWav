 ...
 *
 * Usage:
 *   pnpm tsx apps/api/src/jobs/image-integrity-backfill.ts --report
 *   pnpm tsx apps/api/src/jobs/image-integrity-backfill.ts --apply
 *   pnpm tsx apps/api/src/jobs/image-integrity-backfill.ts --apply --source <sourceId>
 *   pnpm tsx apps/api/src/jobs/image-integrity-backfill.ts --apply --limit 500
 *
