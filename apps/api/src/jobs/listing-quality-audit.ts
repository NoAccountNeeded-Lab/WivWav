 ...
 *   pnpm tsx apps/api/src/jobs/listing-quality-audit.ts --report --json
 *   pnpm tsx apps/api/src/jobs/listing-quality-audit.ts --report --source <sourceId>
 *   pnpm tsx apps/api/src/jobs/listing-quality-audit.ts --report --limit 1000
 *   pnpm tsx apps/api/src/jobs/listing-quality-audit.ts --report --out audit.json
