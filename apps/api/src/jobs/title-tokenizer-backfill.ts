 ...
 *
 * Usage:
 *   pnpm tsx apps/api/src/jobs/title-tokenizer-backfill.ts --report
 *   pnpm tsx apps/api/src/jobs/title-tokenizer-backfill.ts --apply
 *
 ...
 * 2. Run: pnpm tsx apps/api/src/jobs/title-tokenizer-backfill.ts --report
 *    Review output — confirm affected counts and corrected values look right.
 * 3. Run: pnpm tsx apps/api/src/jobs/title-tokenizer-backfill.ts --apply
