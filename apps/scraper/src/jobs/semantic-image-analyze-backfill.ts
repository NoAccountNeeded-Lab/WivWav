 ...
 *
 * Usage:
 *   pnpm tsx apps/scraper/src/jobs/semantic-image-analyze-backfill.ts --report
 *   pnpm tsx apps/scraper/src/jobs/semantic-image-analyze-backfill.ts --apply
 *   pnpm tsx apps/scraper/src/jobs/semantic-image-analyze-backfill.ts --apply --source <sourceId>
 *   pnpm tsx apps/scraper/src/jobs/semantic-image-analyze-backfill.ts --apply --limit 500
 *
 * --report mode:
