 ...
 * apps/scraper/src/engine/listing-validator.ts is enforced for new scrapes,
 ...
 *
 * Usage:
 *   pnpm tsx apps/scraper/src/jobs/publication-backfill.ts --report
 *   pnpm tsx apps/scraper/src/jobs/publication-backfill.ts --apply
 *
 * Always run --report first to review expected quarantine volume and rule
 * breakdown before --apply.
 *
 * Deployment procedure:
 * 1. Run: pnpm tsx apps/scraper/src/jobs/publication-backfill.ts --report
 ...
 * 3. Run: pnpm tsx apps/scraper/src/jobs/publication-backfill.ts --apply
