---
description: Run a development sprint by working on issues labeled status:ready. Spawns up to 1 worker agent at a time, implementing one issue and opening a draft PR. No Anthropic API key required — uses Claude Code's built-in Agent spawning.
argument-hint: ""
---
