...
Implementation: confirm issue; set `status:in-progress`; branch from latest `origin/main`; plan; read narrow ranges; run focused checks; finish with `/wivwav-finish-issue`.
