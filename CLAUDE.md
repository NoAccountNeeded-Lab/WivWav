...
For implementation work, follow the issue workflow: mark the issue `status:in-progress`, branch from latest `main`, plan before file reads, run focused verification, then use `/wivwav-finish-issue` when ready to commit and open a draft PR.
