...
For cross-agent product-design critique (audit/critique/layout/typeset/polish/harden), read `.claude/skills/impeccable/SKILL.md`; it defers to this file and to `docs/BRAND.md` and cannot authorize implementation on `main` or waive a `docs/BRAND.md` review.
